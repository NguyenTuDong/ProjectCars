...
$config = array();
$userDirectory = md5($_SESSION['User']);
...
$config['authentication'] = function () {
    ...
    {
        if(!is_dir('/vnten/public/storage/img/userfiles/'.$userDirectory))
            mkdir('/vnten/public/storage/img/userfiles/'.$userDirectory, 0777);
        return true;
    }
    else
    {
...
$config['privateDir'] = array(
    'backend' => 'default',
    'tags'   => '.ckfinder/' . $userDirectory . '/tags',
    'logs'   => '.ckfinder/' . $userDirectory . '/logs',
    'cache'  => '.ckfinder/' . $userDirectory . '/cache',
    'thumbs' => '.ckfinder/' . $userDirectory . '/cache/thumbs',
);
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/vnten/public/storage/img/userfiles/' .md5($_SESSION['User']),
